 ...
 * <!-- end-user-doc -->
 * @see edu.kit.sdq.dsis.metamodel.unified.UnifiedPackage#getRiskLevel()
 * @model
 * @generated
 */
public enum RiskLevel implements Enumerator {
	 ...
	 * @generated
	 */
	private static final RiskLevel[] VALUES_ARRAY = new RiskLevel[] { NEGLIGIBLE, MARGINAL, CRITICAL_RISK,
			CATASTROPHIC, };
	...
	public static RiskLevel get(int value) {
		switch (value) {
		case NEGLIGIBLE_VALUE:
			return NEGLIGIBLE;
		case MARGINAL_VALUE:
			return MARGINAL;
		case CRITICAL_RISK_VALUE:
