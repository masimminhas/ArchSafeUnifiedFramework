 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.BlockConnectionImpl#getConnectionType <em>Connection Type</em>}</li>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.BlockConnectionImpl#getFromBlock <em>From Block</em>}</li>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.BlockConnectionImpl#getToBlock <em>To Block</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockConnectionImpl extends UnifiedElementImpl implements BlockConnection {
	...
	public void setConnectionType(ConnectionType newConnectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnifiedPackage.BLOCK_CONNECTION__CONNECTION_TYPE,
	...
	public EList<SystemBlock> getFromBlock() {
		if (fromBlock == null) {
			fromBlock = new EObjectWithInverseResolvingEList.ManyInverse<SystemBlock>(SystemBlock.class, this,
					UnifiedPackage.BLOCK_CONNECTION__FROM_BLOCK, UnifiedPackage.SYSTEM_BLOCK__CONNECTION_AS_SOURCE);
		}
		return fromBlock;
	}
	...
	public EList<SystemBlock> getToBlock() {
		if (toBlock == null) {
			toBlock = new EObjectWithInverseResolvingEList.ManyInverse<SystemBlock>(SystemBlock.class, this,
					UnifiedPackage.BLOCK_CONNECTION__TO_BLOCK, UnifiedPackage.SYSTEM_BLOCK__CONNECTION_AS_TARGET);
		}
		return toBlock;
	}
