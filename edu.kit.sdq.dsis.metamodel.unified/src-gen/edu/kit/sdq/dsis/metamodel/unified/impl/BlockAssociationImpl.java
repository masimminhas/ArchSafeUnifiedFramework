 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.BlockAssociationImpl#getAssociationType <em>Association Type</em>}</li>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.BlockAssociationImpl#getSourceBlock <em>Source Block</em>}</li>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.BlockAssociationImpl#getTargetBlock <em>Target Block</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockAssociationImpl extends UnifiedElementImpl implements BlockAssociation {
	...
	public void setAssociationType(AssociationType newAssociationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnifiedPackage.BLOCK_ASSOCIATION__ASSOCIATION_TYPE,
			...
			if (sourceBlock != oldSourceBlock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							UnifiedPackage.BLOCK_ASSOCIATION__SOURCE_BLOCK, oldSourceBlock, sourceBlock));
			}
		}
		return sourceBlock;
	}
	...
	public NotificationChain basicSetSourceBlock(SystemBlock newSourceBlock, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					UnifiedPackage.BLOCK_ASSOCIATION__SOURCE_BLOCK, oldSourceBlock, newSourceBlock);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSourceBlock(SystemBlock newSourceBlock) {
		if (newSourceBlock != sourceBlock) {
			...
			if (sourceBlock != null)
				msgs = ((InternalEObject) sourceBlock).eInverseRemove(this,
						UnifiedPackage.SYSTEM_BLOCK__ASSOCIATION_AS_SOURCE, SystemBlock.class, msgs);
			if (newSourceBlock != null)
				msgs = ((InternalEObject) newSourceBlock).eInverseAdd(this,
						UnifiedPackage.SYSTEM_BLOCK__ASSOCIATION_AS_SOURCE, SystemBlock.class, msgs);
			msgs = basicSetSourceBlock(newSourceBlock, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnifiedPackage.BLOCK_ASSOCIATION__SOURCE_BLOCK,
	...
	public SystemBlock getTargetBlock() {
		if (targetBlock != null && targetBlock.eIsProxy()) {
			...
			if (targetBlock != oldTargetBlock) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							UnifiedPackage.BLOCK_ASSOCIATION__TARGET_BLOCK, oldTargetBlock, targetBlock));
			}
		}
		return targetBlock;
	}
	...
	public NotificationChain basicSetTargetBlock(SystemBlock newTargetBlock, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					UnifiedPackage.BLOCK_ASSOCIATION__TARGET_BLOCK, oldTargetBlock, newTargetBlock);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTargetBlock(SystemBlock newTargetBlock) {
		if (newTargetBlock != targetBlock) {
			NotificationChain msgs = null;
			if (targetBlock != null)
				msgs = ((InternalEObject) targetBlock).eInverseRemove(this,
						UnifiedPackage.SYSTEM_BLOCK__ASSOCIATION_AS_TARGET, SystemBlock.class, msgs);
			if (newTargetBlock != null)
				msgs = ((InternalEObject) newTargetBlock).eInverseAdd(this,
						UnifiedPackage.SYSTEM_BLOCK__ASSOCIATION_AS_TARGET, SystemBlock.class, msgs);
			msgs = basicSetTargetBlock(newTargetBlock, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnifiedPackage.BLOCK_ASSOCIATION__TARGET_BLOCK,
