...
public class UnifiedSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case UnifiedPackage.FMEA_ANALYSIS: {
			...
			if (result == null)
				result = caseUnifiedElement(fmeaAnalysis);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case UnifiedPackage.FMEA_ITEM: {
			...
			if (result == null)
				result = caseUnifiedElement(fmeaItem);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case UnifiedPackage.INTEGRATED_HAZARD: {
			...
			if (result == null)
				result = caseUnifiedElement(integratedHazard);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case UnifiedPackage.SAFETY_CRITICAL_BLOCK: {
			...
			if (result == null)
				result = caseSystemBlock(safetyCriticalBlock);
			if (result == null)
				result = caseUnifiedElement(safetyCriticalBlock);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case UnifiedPackage.SYSTEM_BLOCK: {
			...
			if (result == null)
				result = caseUnifiedElement(systemBlock);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case UnifiedPackage.BLOCK_ASSOCIATION: {
			...
			if (result == null)
				result = caseUnifiedElement(blockAssociation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case UnifiedPackage.BLOCK_CONNECTION: {
			...
			if (result == null)
				result = caseUnifiedElement(blockConnection);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case UnifiedPackage.BLOCK_FAILURE_MODE: {
			...
			if (result == null)
				result = caseUnifiedElement(blockFailureMode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
