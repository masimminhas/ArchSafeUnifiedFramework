 ...
 * <!-- end-user-doc -->
 * @see edu.kit.sdq.dsis.metamodel.unified.UnifiedPackage#getAssociationType()
 * @model
 * @generated
 */
public enum AssociationType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final AssociationType[] VALUES_ARRAY = new AssociationType[] { DEPENDENCY, AGGREGATION, COMPOSITION,
