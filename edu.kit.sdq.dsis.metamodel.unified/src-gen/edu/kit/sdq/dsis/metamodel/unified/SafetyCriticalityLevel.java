 ...
 * <!-- end-user-doc -->
 * @see edu.kit.sdq.dsis.metamodel.unified.UnifiedPackage#getSafetyCriticalityLevel()
 * @model
 * @generated
 */
public enum SafetyCriticalityLevel implements Enumerator {
	 ...
	 * @generated
	 */
	private static final SafetyCriticalityLevel[] VALUES_ARRAY = new SafetyCriticalityLevel[] { LOW, MEDIUM, HIGH,
			CRITICAL, };
