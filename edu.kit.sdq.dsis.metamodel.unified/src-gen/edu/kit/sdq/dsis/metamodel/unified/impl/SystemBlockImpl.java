 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.SystemBlockImpl#getSubBlocks <em>Sub Blocks</em>}</li>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.SystemBlockImpl#getParentBlock <em>Parent Block</em>}</li>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.SystemBlockImpl#getAssociationAsSource <em>Association As Source</em>}</li>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.SystemBlockImpl#getAssociationAsTarget <em>Association As Target</em>}</li>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.SystemBlockImpl#getConnectionAsSource <em>Connection As Source</em>}</li>
 *   <li>{@link edu.kit.sdq.dsis.metamodel.unified.impl.SystemBlockImpl#getConnectionAsTarget <em>Connection As Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemBlockImpl extends UnifiedElementImpl implements SystemBlock {
	...
	public EList<SystemBlock> getSubBlocks() {
		if (subBlocks == null) {
			subBlocks = new EObjectContainmentWithInverseEList<SystemBlock>(SystemBlock.class, this,
					UnifiedPackage.SYSTEM_BLOCK__SUB_BLOCKS, UnifiedPackage.SYSTEM_BLOCK__PARENT_BLOCK);
		}
		return subBlocks;
	}
	...
	public SystemBlock getParentBlock() {
		if (eContainerFeatureID() != UnifiedPackage.SYSTEM_BLOCK__PARENT_BLOCK)
			return null;
	...
	public void setParentBlock(SystemBlock newParentBlock) {
		if (newParentBlock != eInternalContainer()
				|| (eContainerFeatureID() != UnifiedPackage.SYSTEM_BLOCK__PARENT_BLOCK && newParentBlock != null)) {
			...
			if (newParentBlock != null)
				msgs = ((InternalEObject) newParentBlock).eInverseAdd(this, UnifiedPackage.SYSTEM_BLOCK__SUB_BLOCKS,
						SystemBlock.class, msgs);
			msgs = basicSetParentBlock(newParentBlock, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnifiedPackage.SYSTEM_BLOCK__PARENT_BLOCK,
	...
	public EList<BlockAssociation> getAssociationAsSource() {
		if (associationAsSource == null) {
			associationAsSource = new EObjectWithInverseResolvingEList<BlockAssociation>(BlockAssociation.class, this,
					UnifiedPackage.SYSTEM_BLOCK__ASSOCIATION_AS_SOURCE, UnifiedPackage.BLOCK_ASSOCIATION__SOURCE_BLOCK);
		}
	...
	public EList<BlockAssociation> getAssociationAsTarget() {
		if (associationAsTarget == null) {
			associationAsTarget = new EObjectWithInverseResolvingEList<BlockAssociation>(BlockAssociation.class, this,
					UnifiedPackage.SYSTEM_BLOCK__ASSOCIATION_AS_TARGET, UnifiedPackage.BLOCK_ASSOCIATION__TARGET_BLOCK);
		}
	...
	public EList<BlockConnection> getConnectionAsSource() {
		if (connectionAsSource == null) {
			connectionAsSource = new EObjectWithInverseResolvingEList.ManyInverse<BlockConnection>(
					BlockConnection.class, this, UnifiedPackage.SYSTEM_BLOCK__CONNECTION_AS_SOURCE,
					UnifiedPackage.BLOCK_CONNECTION__FROM_BLOCK);
		}
	...
	public EList<BlockConnection> getConnectionAsTarget() {
		if (connectionAsTarget == null) {
			connectionAsTarget = new EObjectWithInverseResolvingEList.ManyInverse<BlockConnection>(
					BlockConnection.class, this, UnifiedPackage.SYSTEM_BLOCK__CONNECTION_AS_TARGET,
					UnifiedPackage.BLOCK_CONNECTION__TO_BLOCK);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case UnifiedPackage.SYSTEM_BLOCK__ASSOCIATION_AS_SOURCE:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getAssociationAsSource()).basicAdd(otherEnd,
					msgs);
		case UnifiedPackage.SYSTEM_BLOCK__ASSOCIATION_AS_TARGET:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getAssociationAsTarget()).basicAdd(otherEnd,
					msgs);
		case UnifiedPackage.SYSTEM_BLOCK__CONNECTION_AS_SOURCE:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getConnectionAsSource()).basicAdd(otherEnd,
					msgs);
		case UnifiedPackage.SYSTEM_BLOCK__CONNECTION_AS_TARGET:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getConnectionAsTarget()).basicAdd(otherEnd,
					msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case UnifiedPackage.SYSTEM_BLOCK__PARENT_BLOCK:
			return eInternalContainer().eInverseRemove(this, UnifiedPackage.SYSTEM_BLOCK__SUB_BLOCKS, SystemBlock.class,
					msgs);
		}
