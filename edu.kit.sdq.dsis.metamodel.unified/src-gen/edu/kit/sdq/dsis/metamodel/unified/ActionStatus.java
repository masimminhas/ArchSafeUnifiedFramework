 ...
 * <!-- end-user-doc -->
 * @see edu.kit.sdq.dsis.metamodel.unified.UnifiedPackage#getActionStatus()
 * @model
 * @generated
 */
public enum ActionStatus implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ActionStatus[] VALUES_ARRAY = new ActionStatus[] { OPEN, IN_PROGRESS, COMPLETED, VERIFIED, };
