 ...
 * <!-- end-user-doc -->
 * @see edu.kit.sdq.dsis.metamodel.unified.UnifiedPackage#getConnectionType()
 * @model
 * @generated
 */
public enum ConnectionType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ConnectionType[] VALUES_ARRAY = new ConnectionType[] { DATA_FLOW, CONTROL_FLOW, POWER_FLOW,
			SIGNAL_FLOW, MECHANICAL, };
	...
	public static ConnectionType get(int value) {
		switch (value) {
		case DATA_FLOW_VALUE:
			return DATA_FLOW;
		case CONTROL_FLOW_VALUE:
			return CONTROL_FLOW;
		case POWER_FLOW_VALUE:
			return POWER_FLOW;
		case SIGNAL_FLOW_VALUE:
			return SIGNAL_FLOW;
